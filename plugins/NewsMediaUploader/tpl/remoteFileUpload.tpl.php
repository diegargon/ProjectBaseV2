...
<div class="submit_items">
    <p>
        ...
        <input value="" minlength="<?= $cfg['NEWS_LINK_MIN_LENGHT'] ?>" maxlength="<?= $cfg['NEWS_LINK_MAX_LENGHT'] ?>" id="news_remote_media" class="news_remote_link" name="news_remote_media" type="text" placeholder="http://site.com/image.jpg"/>
